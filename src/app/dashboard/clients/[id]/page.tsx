...
import type { GbpReport, CommerceReport } from "@/lib/integrations/metrics";
...
const HAS_VIZ = new Set(["gsc", "ga4", "instagram", "google_ads", "meta_ads", "linkedin_ads", "tiktok_ads", "gbp", "shopify"]);
