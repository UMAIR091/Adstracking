...
const BADGE: Record<ChangeType, { label: string; cls: string; Icon: typeof Sparkles }> = {
  new: { label: "New", cls: "bg-success-50 text-success-700", Icon: Sparkles },
  improved: { label: "Improved", cls: "bg-info-50 text-info-700", Icon: ArrowUpRight },
  fixed: { label: "Fixed", cls: "bg-warning-50 text-warning-700", Icon: Wrench },
};
