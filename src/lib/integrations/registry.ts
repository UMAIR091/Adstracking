...
import { gscDef, ga4Def, metaAdsDef, instagramDef, googleAdsDef, gbpDef, soonDefs } from "./providers";
...
const DEFS: IntegrationDef[] = [gscDef, ga4Def, googleAdsDef, metaAdsDef, instagramDef, gbpDef, ...soonDefs];
